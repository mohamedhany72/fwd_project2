...
var OrderModel = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("error get orders ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "SELECT * FROM public.orders WHERE id=$1;";
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("error get order ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("error create order ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    // update order
    OrderModel.prototype.updateStatus = function (id, status) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                WHERE id=$2 RETURNING *;";
                    ...
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [status, id])];
                    case 2:
                        result = _a.sent();
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("error update order ".concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("error delete order ".concat(err_5));
                    case 4: return [2 /*return*/];
                }
            });
        });
