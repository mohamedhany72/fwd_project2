...
var UserModel = /** @class */ (function () {
    ...
    UserModel.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var hash, sql, conn, result, user, err_1;
            return __generator(this, function (_a) {
                ...
                VALUES ( $1, $2, $3) RETURNING *";
                    ...
                    case 4:
                        err_1 = _a.sent();
                        throw new Error("Could not add user ".concat(u.firstname, " ").concat(u.lastname, ". Error: ").concat(err_1));
    ...
    UserModel.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, users, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        sql = "SELECT id, firstname, lastname FROM public.users;";
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, database_1.default.connect()];
                    ...
                    case 4:
                        err_2 = _a.sent();
                        throw new Error("error getting users: ".concat(err_2));
                    case 5: return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        if (result.rows.length) {
                            user = result.rows[0];
                            return [2 /*return*/, { success: 1, user: user }];
                        }
                        return [2 /*return*/, { success: 0 }];
                    case 4:
                        err_3 = _a.sent();
                        throw new Error("error getting user: ".concat(err_3));
                    case 5: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        err_4 = _a.sent();
                        throw new Error("error deleting user: ".concat(err_4));
                    case 5: return [2 /*return*/];
                }
            });
        });
