...
var DashboardQueries = /** @class */ (function () {
    ...
    DashboardQueries.prototype.productsInAllOrders = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "SELECT name, price, quantity, order_id FROM orders_products\
    ...
    // Get all products that have been included in orders
    DashboardQueries.prototype.productsInOrder = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            WHERE orders_products.order_id = $1";
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("unable get products and order: ".concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
