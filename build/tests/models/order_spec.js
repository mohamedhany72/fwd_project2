...
describe("Testing Model: Order", function () {
    ...
    it("create method should create the order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderClass.create(order)];
                case 1:
                    result = _a.sent();
    ...
    it("index method should return order in array", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderClass.index()];
    ...
    it("show method should return the order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderClass.show(1)];
                case 1:
                    result = _a.sent();
    ...
    it("update status method should exist", function () {
        expect(orderClass.updateStatus).toBeDefined();
    });
    it("update status method should update the order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, orderClass.updateStatus(1, "complete")];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual({
                        id: 1,
    ...
    it("delete method should delete the order", function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
